...
const CrearEvento = () => {
   ...
   const api = helphttp();
   const url =
      "https://server.eventosdemarinera.com/useradmin/listOrganizadores";
   const url_createEvent =
      "https://server.eventosdemarinera.com/useradmin/createEvento";
      ...
      const senData = async () => {
         try {
            if (imagAgredada) {
               ...
               const consult = await api.post(url_createEvent, opciones);
   ...
   return (
      <>
         ...
         {!form.tipos_evento_cod_tipo && (
            <article className="container-eventos">
         ...
         {form.tipos_evento_cod_tipo && !continuar ? (
            <form className="formu" action="">
               <button onClick={regresar} className="buttonCancel">
                  Cancelar
               </button>
               <section className="inputs">
                  <div className="part1">
                     ...
                     >
                        <option value="">Seleccione la Organizacion</option>
                        {organizadores.map((org, i) => (
                           <option key={i} value={org.cod_organizador}>
                              {org.nombre_org}
                           </option>
                        ))}
                     </select>
                     <select name="cod_ciudad" onChange={handleChange}>
                        <option value="">Seleccione un departamnto</option>
                        {departamentos.map((dep, i) => (
                           <option key={i} value={dep.cod_ciudad}>
                              {dep.nombre}
                           </option>
                        ))}
                     </select>
         ...
         {form.tipos_evento_cod_tipo && continuar && (
            <section className="sec_cat_mod">
               <button onClick={cancelar} className="buttonCancel">
                  cancelar
               </button>
